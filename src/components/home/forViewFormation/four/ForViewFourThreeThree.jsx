...
const ForViewFourThreeThree = ({ post }) => {
  return (
    <div className="container-fluid w-100 p-3">
      <div className="position-relative d-flex vstack gap-0 h-100">
        ...
        >
          ...
          >
            {/* player1 */}
            <div className="player1 d-flex flex-column justify-content-center align-self-end align-items-center">
            ...
            {/* player3 */}
            <div className="player3 d-flex flex-column justify-content-center align-self-end align-items-center">
              <CircleIcon sx={{ color: "#FFFFEF" }} />
              {/* 選手名 */}
...
export default ForViewFourThreeThree;
