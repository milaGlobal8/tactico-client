...
const ForViewFourFourOneOne = ({ post }) => {
  return (
    <div className="container-fluid w-100 p-3">
      <div className="position-relative d-flex vstack gap-0 h-100">
        ...
        >
          ...
          <div
            id="rowAMF"
            className="rowAMF d-flex justify-content-center flex-grow-1"
          >
            {/* player2 */}
          ...
          <div
            id="rowDMF"
            className="rowDMF d-flex justify-content-around flex-grow-1"
          >
            {/* player3 */}
            <div className="player3 d-flex flex-column justify-content-center align-self-start align-items-center">
              <CircleIcon sx={{ color: "#FFFFEF" }} />
              {/* 選手名 */}
            ...
            {/* player6 */}
            <div className="player6 d-flex flex-column justify-content-center align-self-start align-items-center">
              <CircleIcon sx={{ color: "#FFFFEF" }} />
              {/* 選手名 */}
...
export default ForViewFourFourOneOne;
