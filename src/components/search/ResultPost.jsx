...
const ResultPost = ({ posts }) => {
  ...
  return (
    <div className="result_posts container-fluid p-0 border-bottom border-dark">
      {/* 投稿 */}
      <div className="result_posts_box" style={{ flex: 1 }}>
        {posts.map((post) => (
          <div
            key={post._id}
            className="result_post container-fluid border border-dark p-0 m-0 d-flex"
