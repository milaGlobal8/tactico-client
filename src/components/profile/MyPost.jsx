...
const MyPost = ({ posts }) => {
  ...
  return (
    <div className="my_posts container-fluid p-0 border-bottom border-dark">
      {/* 投稿 */}
      <div className="my_posts_box" style={{ flex: 1 }}>
        {posts.map((post) => (
          <div
            key={post._id}
            className="my_post container-fluid border border-dark p-0 m-0 d-flex"
